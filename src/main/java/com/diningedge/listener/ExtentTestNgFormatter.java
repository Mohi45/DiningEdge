package com.diningedge.listener;
...
import com.diningedge.NodeName;
import com.diningedge.SystemInfo;
...
public class ExtentTestNgFormatter implements ISuiteListener, ITestListener, IInvokedMethodListener, IReporter {
	...
	public ExtentTestNgFormatter() {
		...
		String reportPathStr = System.getProperty("user.dir")+"/target/surefire-reports/";
		File reportPath;

		try {
			System.out.println("**************+"+reportPathStr);
			reportPath = new File(reportPathStr);
			System.out.println("**************after+"+reportPathStr);
		...
		System.out.println("**************here+"+reportPathStr);
...
//		EmailReporter emailReporter = new EmailReporter(emailReportFile);
		...
		System.out.println("**************there+"+reportPathStr);
